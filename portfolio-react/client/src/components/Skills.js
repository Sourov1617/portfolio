...
const Skills = () => {
  ...
  return (
    <section id="skills" className="section" ref={ref} style={{background: 'var(--secondary-bg)'}}>
      <div className="container">
        ...
        >
          ...
          <div style={{marginBottom: '4rem'}}>
            <h3 style={{color: 'var(--primary-color)', fontSize: '1.8rem', marginBottom: '2rem', textAlign: 'center'}}>
              Technical Skills
            </h3>
