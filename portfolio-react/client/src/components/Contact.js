...
const Contact = () => {
  ...
  return (
    <section id="contact" className="section" ref={ref} style={{background: 'var(--primary-bg)'}}>
        ...
        >
          ...
          <div style={{display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', marginTop: '3rem', alignItems: 'start'}}>
            ...
            <motion.div
              ...
              style={{padding: '3rem'}}
            >
              <h3 className="holographic-text" style={{marginBottom: '2rem', fontSize: '1.5rem'}}>
                Send Me a Message
              </h3>
              ...
              <form onSubmit={handleSubmit}>
                ...
                {submitStatus === 'success' && (
                  <p style={{color: 'var(--primary-color)', marginTop: '1rem', textAlign: 'center'}}>
                    Message sent successfully! 🎉
                  </p>
                )}
                {submitStatus === 'error' && (
                  <p style={{color: 'var(--secondary-color)', marginTop: '1rem', textAlign: 'center'}}>
            ...
            >
              <div className="glass-container" style={{padding: '3rem', marginBottom: '2rem'}}>
                <h3 className="holographic-text" style={{marginBottom: '2rem', fontSize: '1.5rem'}}>
                  Let's Connect!
                </h3>
                ...
                <div style={{marginBottom: '2rem'}}>
                  <h4 style={{color: 'var(--primary-color)', marginBottom: '1rem'}}>Quick Contact</h4>
              ...
              <div className="glass-container" style={{padding: '2rem'}}>
                <h4 className="holographic-text" style={{marginBottom: '1.5rem', fontSize: '1.2rem'}}>
                  Follow Me
                </h4>
